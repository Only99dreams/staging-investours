  ...
  "rounded-xl border text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        glass: "bg-card/60 backdrop-blur-md border-border/30 shadow-lg",
        feature: "bg-card border-border/50 shadow-lg hover:shadow-xl hover:-translate-y-1 cursor-pointer",
        outlined: "bg-transparent border-2 border-border hover:border-primary",
        accent: "bg-secondary border-primary/20 shadow-md",
      },
    },
    defaultVariants: {
      variant: "default",
