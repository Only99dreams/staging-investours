  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Ranked by number of followers referred</CardDescription>
      </CardHeader>
      <CardContent>
        {isLoading ? (
          <div className="flex items-center justify-center py-12">
            ...
            {entries.map((entry, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="w-10 h-10 rounded-full bg-muted flex items-center justify-center flex-shrink-0 text-xs font-bold text-muted-foreground">
